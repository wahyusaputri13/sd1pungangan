...
class FlipbookController extends Controller
{
    ...
    {
        // if ($request->ajax()) {
        //     $data = Upload::orderBy('date', 'DESC')->get();
    ...
    public function create()
    {
        ...
        foreach($departments as $department){
            $select[$department->kategori_kelas] = $department->kategori_kelas.' - '.$department->nama_guru;
        }
    ...
    {
        $data = Upload::find($id);
        return view('back.a.pages.upload.edit', compact('data'));
    }
    ...
    //         $validated = $request->validate([
    //             'path_pdf' => 'path_pdf|mimes:doc,docx,pdf,xls,xlsx,ppt,pptx|',
    ...
    //         if ($request->file('path_pdf')->getClientOriginalName() != $upload->path_pdf) {
    //             // delate old file
    //             Storage::delete($upload->path_pdf);
    //             $name = $request->file('path_pdf')->getClientOriginalName();
    //             $path = $request->file('path_pdf')->store('upload');
    //             $data = [
    //                 'photo' => $name,
    //                 'path' => $path,
    //                 'title' => $request->title,
    ...
    //     return redirect(route('upload.index'))->with(['success' => 'Data has been successfully changed!']);
    // }
